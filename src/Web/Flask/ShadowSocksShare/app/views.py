...
def pages(path):
    ...
    remarks = servers[a]['data'][b]['remarks'] if 'remarks' in servers[a]['data'][b] else ''
    server = servers[a]['data'][b]['server'] if 'server' in servers[a]['data'][b] else ''
    server_port = servers[a]['data'][b]['server_port'] if 'server_port' in servers[a]['data'][b] else ''
    password = servers[a]['data'][b]['password'] if 'password' in servers[a]['data'][b] else ''
    method = servers[a]['data'][b]['method'] if 'method' in servers[a]['data'][b] else ''
    ssr_protocol = servers[a]['data'][b]['ssr_protocol'] if 'ssr_protocol' in servers[a]['data'][b] else ''
    obfs = servers[a]['data'][b]['obfs'] if 'obfs' in servers[a]['data'][b] else ''
    href = servers[a]['data'][b]['href'] if 'href' in servers[a]['data'][b] else ''
    json = servers[a]['data'][b]['json'] if 'json' in servers[a]['data'][b] else ''
    obfsparam = servers[a]['data'][b]['obfsparam'] if 'obfsparam' in servers[a]['data'][b] else ''
    protoparam = servers[a]['data'][b]['protoparam'] if 'protoparam' in servers[a]['data'][b] else ''
    color, opacity, count = gen_canvas_nest()
